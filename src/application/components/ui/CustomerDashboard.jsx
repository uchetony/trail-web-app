...
const CustomerDashboard = ({userDetails, handleUpdateToken}) => {
            ...
            <div className="dashboard-control-panel">
                ...
                {(!isVerifiedEmail && meterId) && (
                    <div className="verify-email">
                        <div className="icon-holder"> <FontAwesomeIcon icon="exclamation" /> </div>
                        <small>
                            Hi {userDetails.fullName} , please check your mailbox to verify your email and have access to all Trail features.
                            Or you can
                        </small>
                        ...
                        <a href="https://mail.google.com/mail/u/0/#inbox" target="_blank">Verify now</a>
                    </div>
                )}
                            ...
                            <div className="dashboard-meter">
                                {
                                    meterCards.map((el, index) => (
                                        <div key={index} className={activeCard.includes(index) ? 'meter-card-active' : 'meter-card'} >
                                            ...
                                            {!el.button && <h3>{currentPlan  ? el.data : 0 } <span> {el.unit} </span></h3>}
